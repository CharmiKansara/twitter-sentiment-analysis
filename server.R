...
shinyServer(function(input, output, session) {
  consumer_api_key <- "k3LUaTKG2wSMK2EfJTwdoagDW" # Enter your consumer key
  consumer_api_secret <- "aOKp6NM5aHAZe9JLEOJWqo5j5A2nwLqmrXK8SKvFWIF3LYVkLQ" # Enter your consumer secret
  access_token <- "1430424315221082118-KZ6t08cwgZ3FOVRotypCKlMMuL7TN6" # Enter your access token
  access_token_secret <- "JEC4hZRgfeoavKcI4YvMC6pocKJDhqG45Hb82UN7Tzezy" # Enter your access secret
